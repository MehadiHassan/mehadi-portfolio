...
<a class="navbar-brand" href="index.html">Mehadi Hsssan </a>
    ...
    <div class="p-4">
      ...
      <div class="container-fluid quote-container">
        <div class="quotes" style="text-align:center;">
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="#fff">
            <path d="M7 21a4 4 0 0 1-4-4c0-1.473 1.333-6.14 4-14h2L7 13a4 4 0 1 1 0 8zm10 0a4 4 0 0 1-4-4c0-1.473 1.333-6.14 4-14h2l-2 10a4 4 0 1 1 0 8z"/>
          </svg>
        </div>
        <p class="tag">Fuel your curiosity—grow endlessly.</p>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
            <!-- Your existing smiley face SVG illustration goes here -->
            <!-- Keep your long SVG content here as-is -->
          </div>
  
          <!-- Right Side Contact Icons -->
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0 d-flex align-items-center justify-content-center">
            <div class="rounded-social-buttons">
              <!-- Email Icon -->
              <a href="mailto:mehadihassan@example.com" title="Email">
                <svg fill="#ffffff" height="45px" width="45px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                  <path d="M502.3 190.8L327.4 338c-15.7 13.4-39 13.4-54.7 0L9.7 190.8C3.9 185.6 0 177.7 0 169.1V384c0 35.3 28.7 64 64 64h384c35.3 0 64-28.7 64-64V169.1c0-8.6-3.9-16.5-9.7-21.7zM256 320L480 144H32l224 176z"/>
                </svg>
              </a>
  
              <!-- LinkedIn Icon -->
              <a href="https://www.linkedin.com/in/mehadi-hassan-kuet-cse/" target="_blank" title="LinkedIn">
                <svg fill="#0A66C2" width="45px" height="45px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                  <path d="M100.28 448H7.4V148.9h92.88zm-46.44-340c-31.5 0-57-25.6-57-57.2C-3.16 19.5 22.6-6 54.08-6c31.48 0 57 25.6 57 57.2 0 31.7-25.52 57.3-57.24 57.3zM507.9 448h-92.4V302.4c0-34.7-12.4-58.4-43.3-58.4-23.6 0-37.6 15.9-43.7 31.2-2.2 5.3-2.8 12.7-2.8 20.1V448h-92.4s1.2-261.6 0-288.1h92.4v40.8c12.3-19 34.2-46.1 83.3-46.1 60.8 0 106.4 39.7 106.4 125V448z"/>
                </svg>
              </a>
  
              <!-- GitHub Icon -->
              <a href="https://github.com/MehadiHassan" target="_blank" title="GitHub">
                <svg fill="#ffffff" height="45px" width="45px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 0C3.58 0 0 3.582 0 8.002c0 3.54 2.29 6.533 5.47 7.59.4.074.55-.174.55-.386 0-.19-.007-.693-.01-1.36-2.226.483-2.695-1.073-2.695-1.073-.364-.924-.89-1.17-.89-1.17-.726-.497.055-.487.055-.487.803.056 1.225.824 1.225.824.714 1.223 1.872.87 2.33.665.072-.517.28-.87.508-1.07-1.776-.202-3.644-.888-3.644-3.953 0-.874.312-1.588.824-2.15-.083-.202-.357-1.017.078-2.12 0 0 .672-.215 2.2.82.64-.178 1.325-.267 2.007-.27.682.003 1.368.092 2.008.27 1.527-1.035 2.198-.82 2.198-.82.437 1.103.163 1.918.08 2.12.513.562.823 1.276.823 2.15 0 3.073-1.87 3.75-3.652 3.947.287.247.543.735.543 1.48 0 1.07-.01 1.932-.01 2.194 0 .214.148.463.553.384C13.71 14.533 16 11.54 16 8.002 16 3.582 12.42 0 8 0z"/>
                </svg>
              </a>
            </div>
          </div>
